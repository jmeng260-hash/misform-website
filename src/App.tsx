  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <h5 className="text-[0.65rem] md:text-[0.75rem] font-bold tracking-[0.2em] uppercase whitespace-nowrap group-hover:text-[#ff1e00] transition-colors">
          {title}
        </h5>
      </div>
      <ul className="flex flex-col gap-1 pl-3.5 opacity-50 group-hover:opacity-100 transition-opacity duration-300">
        {items.map((item, idx) => (
          <li
            key={idx}
            className="text-[0.65rem] font-mono tracking-wider lowercase"
          >
            - {item}
          </li>
        ))}
  ...
  return (
    <div className="relative w-full overflow-hidden bg-white/50 py-16 px-4 md:px-12 selection:bg-[#ff1e00] selection:text-white border border-black/5 mt-8">
      ...
      <div className="absolute inset-0 pointer-events-none flex items-center justify-center opacity-[0.02] overflow-hidden select-none">
        <div className="text-[30vw] font-bold tracking-tighter leading-none mx-[-20%]">
          MISFORM
        </div>
      </div>
      ...
      <div className="flex flex-col xl:flex-row gap-12 lg:gap-8 xl:gap-16 items-center justify-center relative z-10 w-full max-w-[1600px] mx-auto">
        ...
        >
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
            <motion.line
              ...
              y2="15%"
              stroke="currentColor"
              className="text-black/10 transition-colors duration-300 group-hover:text-black/30"
              strokeWidth="1"
            />
            <motion.line
              initial={{ pathLength: 0, opacity: 0 }}
          ...
          <div
            ...
            className="hover:-translate-y-1 hover:translate-x-1 transition-transform duration-300"
          >
            <MindMapNode
              title="IDENTITY"
              items={[
          ...
          <div
            style={{ position: "absolute", top: "15%", left: "65%" }}
            className="hover:-translate-y-1 hover:-translate-x-1 transition-transform duration-300"
          >
            <MindMapNode
              title="LOVE / POETRY"
              items={["love poetry", "lyric poetry", "emotional storytelling"]}
              position=""
              delay={0.3}
            />
          </div>
          ...
          >
            <MindMapNode
              title="NAME MEANING"
              items={["ERATO → EROS", "passion & desire"]}
              position=""
              delay={0.4}
            />
          </div>
          ...
          >
            <MindMapNode
              title="ROLE AMONG MUSES"
              items={["muse of love poetry"]}
              position=""
              delay={0.6}
            />
          </div>
        ...
        >
          ...
          >
            <MindMapNode
              title="AESTHETIC"
              items={["dark tones", "relaxed attitude", "edgy character"]}
              position=""
              delay={0.3}
            />
          </div>
          ...
          >
            <MindMapNode
              ...
              items={["loose tailoring", "raw edges", "deconstructed"]}
              position=""
              delay={0.4}
            />
          </div>
          <div
            style={{ position: "absolute", top: "32%", left: "2%" }}
            className="hover:translate-x-2 transition-transform duration-300"
          >
            <MindMapNode
              title="CORE BELIEFS"
              items={["independent", "romantic observer"]}
              position=""
              delay={0.5}
            />
          </div>
          <div
            style={{ position: "absolute", top: "42%", left: "65%" }}
            className="hover:-translate-x-2 transition-transform duration-300"
          >
            <MindMapNode
              title="BODY & RELATIONSHIP"
              items={["confidence", "ease of movement"]}
              position=""
              delay={0.6}
            />
          </div>
          <div
            style={{ position: "absolute", top: "75%", left: "8%" }}
            className="hover:translate-y-1 hover:translate-x-1 transition-transform duration-300"
          >
            <MindMapNode
              title="WARDROBE STRUCTURE"
              items={["small, versatile", "cross-context"]}
              position=""
              delay={0.7}
            />
          </div>
          ...
          >
            <MindMapNode
              title="SPACE & CONTEXT"
              items={["city at night", "waterfronts"]}
              position=""
              delay={0.8}
            />
          </div>
          <div
            style={{ position: "absolute", top: "83%", left: "35%" }}
            className="hover:translate-y-2 transition-transform duration-300"
          >
            <MindMapNode
              title="ERATO CONNECTION"
              items={["modern muse", "lyrical presence"]}
              position=""
              delay={0.9}
            />
          </div>
    ...
    <div className="relative w-screen min-h-screen overflow-x-hidden bg-[#f2f2f2] font-sans text-[#111111] antialiased">
        ...
        {[0, 1, 2].map((i) => (
          <motion.div
            ...
            style={{
              ...
              textShadow:
                "0 0 18px rgba(255,255,255,0.65), 0 28px 60px rgba(0,0,0,0.16)",
              ...
              <section className="flex flex-col items-center text-center w-full max-w-[1280px] px-14">
                    ...
                    {LOGO_CHARS.map((item, idx) => (
                      <motion.span
                        ...
                        variants={{
                          ...
                          animate: isHovered
                            ? { x: 0, y: 0, rotate: 0, scaleY: 1, skewX: 0 }
                            : item.initial,
                        }}
                        transition={{
                          type: "spring",
                        ...
                        style={{
                          ...
                          textShadow:
                            "0 0 6px rgba(255, 255, 255, 0.25), 0 0 2px rgba(0, 0, 0, 0.2), 0 1px 1px rgba(0, 0, 0, 0.25)",
                        }}
                      >
                        {item.char}
                      </motion.span>
                    ...
                    {LOGO_CHARS.map((item, idx) => (
                      <motion.span
                        ...
                        style={{
                          ...
                          opacity: 1,
                          filter:
                            "url(#calmDistortion) blur(0.2px) contrast(1.1)",
                          WebkitTextStroke: "0.5px rgba(0, 0, 0, 0.25)",
                          textShadow:
                            "0 0 6px rgba(255, 255, 255, 0.25), 0 0 2px rgba(0, 0, 0, 0.2), 0 1px 1px rgba(0, 0, 0, 0.25)",
                        }}
                ...
                >
                  <p className="max-w-[500px] text-[1.1rem] leading-[1.6] tracking-[-0.01em] text-black/80">
                    A visual system built from distortion, softness, and
                    controlled misalignment. Embracing the beauty of the broken
                    form.
                  </p>
                  <motion.div
          ...
          <main className="relative flex flex-col items-center pt-[25vh] pb-[10vh] px-8 min-h-screen">
            ...
            >
              <div className="flex flex-col gap-4">
                <h2 className="text-[0.7rem] tracking-[0.4em] uppercase opacity-40">
                  Collections Archive
                </h2>
                  ...
                  <div key={num} className="border-b border-black/5 pb-12">
                    ...
                    >
                      <div className="flex items-baseline gap-6">
                        ...
                        <h3
                          className={`text-[3.5rem] font-black tracking-tight leading-none transition-all ${activeSubtitle === num ? "opacity-100 scale-105 origin-left" : "opacity-60 group-hover:opacity-80"}`}
                        >
                    ...
                    <motion.div
                      ...
                      animate={{
                        ...
                        transitionEnd: {
                          overflow:
                            activeSubtitle === num ? "visible" : "hidden",
                        },
                      }}
                    >
                        ...
                        {num === 1 ? (
                            ...
                            {[
                              ...
                              <div key={pIdx} className="flex flex-col gap-4">
                                <button
                                  onClick={() =>
                                    setActivePhase(
                                      activePhase === pIdx ? null : pIdx,
                                    )
                                  }
                                  className="flex items-center gap-4 group cursor-pointer hover:pl-2 transition-all"
                                >
                                  <span className="text-[0.6rem] font-mono opacity-40">
                                    {pIdx + 1}.
                                  </span>
                                  <span
                                    className={`text-[0.9rem] tracking-widest uppercase transition-opacity ${activePhase === pIdx ? "opacity-100 font-bold" : "opacity-50 group-hover:opacity-80"}`}
                                  >
                                    {phase}
                                  </span>
                                </button>
                                  ...
                                  {pIdx === 0 ? (
                                    <div className="pl-4 md:pl-12 pb-32 max-w-[1500px]">
                                      ...
                                      <div className="flex flex-wrap gap-8 md:gap-16 border-b border-black/10 mb-12 md:mb-20">
                                        {["Muse Research", '"MUSE" JUDY'].map(
                                          (tab, tIdx) => (
                                            <button
                                              key={tIdx}
                                              onClick={() =>
                                                setActiveResearchTab(tIdx)
                                              }
                                            ...
                                            >
                                              ...
                                              {activeResearchTab === tIdx && (
                                                <motion.div
                                                  ...
                                                  className="absolute bottom-0 left-0 right-0 h-[2px] bg-[#ff1e00]"
                                                />
                                              )}
                                            </button>
                                          ),
                                        ...
                                        {activeResearchTab === 0 && (
                                          <div className="flex flex-col">
                                            ...
                                            <div className="flex flex-col gap-6 pt-0 lg:pt-8 text-center items-center mb-8 lg:mb-16">
                                              ...
                                              >
                                                Muse Research
                                                <span className="block text-[0.8rem] tracking-[0.4em] uppercase opacity-40 mt-6">
                                                  Section_001.Erato
                                                </span>
                                              </motion.h4>
                                              ...
                                              <div className="text-[1.1rem] leading-relaxed text-black/60 max-w-[700px] font-light mt-4">
                                                <p>
                                                  Erato represents artistic
                                                  inspiration connected to love
                                                  and lyrical expression,
                                                  especially in poetry and
                                                  music. Her name derives from
                                                  the Greek word “Eros,” meaning
                                                  romantic love or desire.
                                                </p>
                                              </div>
                                            </div>
                                              ...
                                              >
                                                ...
                                                >
                                                  <div className="text-center">
                                                    <p className="text-[0.65rem] tracking-[0.5em] font-mono opacity-20 uppercase transition-opacity duration-300 group-hover:opacity-60">
                                                      Scale_Asset:
                                                      ERATO_HIGH_RES.001
                                                    </p>
                                                  </div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 items-start mt-0 md:mt-4 lg:mt-8">
                                              ...
                                              <div className="flex flex-col gap-5">
                                                <div className="flex items-center gap-4">
                                                  ...
                                                  <p className="font-bold text-[1.1rem] uppercase tracking-tighter">
                                                    Domain & Artistic Role
                                                  </p>
                                                </div>
                                                <div className="text-[1rem] text-black/80 leading-relaxed">
                                                  <p className="mb-4">
                                                    As the primary muse of
                                                    lyrical expression, Erato
                                                    governs the emotional
                                                    translation of human
                                                    experience into sound and
                                                    rhythm.
                                                  </p>
                                              ...
                                              <div className="flex flex-col gap-5">
                                                ...
                                                <div className="grid grid-cols-2 gap-3">
                                                  {[
                                                    ...
                                                    <div
                                                      key={item}
                                                      className="p-3 border border-black/5 bg-black/[0.02] text-[0.8rem] uppercase tracking-widest font-medium text-black/60"
                                                    >
                                                      {item}
                                                    </div>
                                                  ))}
                                              ...
                                              <div className="flex flex-col gap-5">
                                                ...
                                                <div className="space-y-6">
                                                  <div className="flex flex-col gap-1">
                                                    <span className="text-[0.65rem] tracking-[0.3em] font-bold text-[#ff1e00]">
                                                      INSTRUMENT
                                                    </span>
                                                    <p className="text-[0.95rem] text-black/80">
                                                      The **Lyre or Kithara** –
                                        ...
                                        {activeResearchTab === 1 && (
                                          <div className="relative flex flex-col gap-16 md:gap-24 items-center py-16">
                                            ...
                                            <div className="w-full max-w-[800px] flex-shrink-0 relative group [perspective:1000px]">
                                              ...
                                              >
                                                <p className="text-[0.55rem] tracking-[0.4em] font-mono text-black/30 uppercase">
                                                  Fig_01. Observing
                                                </p>
                                              </motion.div>
                                            </div>
                                            ...
                                            >
                                              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 lg:gap-16">
                                                {[
                                                  ...
                                                  >
                                                    <div className="text-[0.65rem] tracking-[0.3em] font-mono text-black/30 uppercase border-b border-black/10 pb-2 mb-2">
                                                      Part 0{i + 1}
                                                    </div>
                                                    <p>{text}</p>
                                                  </motion.div>
                                              ...
                                              >
                                                ...
                                                <p className="font-normal text-black/90 text-[1.1rem]">
                                                  ...
                                                  the spirit of Erato, the Greek
                                                  muse associated with love and
                                                  lyrical expression. Similar to
                                                  Erato, she experiences romance
                                                  through atmosphere,
                                                  observation, and emotional
                                                ...
                                                >
                                                  ...
                                                  <motion.img
                                                    whileHover={{
                                                      scale: 1.03,
                                                      filter:
                                                        "brightness(0.95) contrast(1.2) sepia(0.2) hue-rotate(-10deg)",
                                                    }}
                                            ...
                                            >
                                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 text-[0.9rem] leading-relaxed text-black/70 font-light">
                                                ...
                                                <motion.div
                                                  ...
                                                  className="flex flex-col gap-4"
                                                >
                                                  <h4 className="text-[0.65rem] tracking-[0.3em] font-bold text-black uppercase border-b border-black/10 pb-2">
                                                    WHO
                                                  </h4>
                                                  <ul className="flex flex-col gap-3">
                                                    <li>
                                                    ...
                                                    <li>
                                                      ...
                                                      <br />
                                                      Creative students or
                                                      individuals working in
                                                      artistic or flexible
                                                      environments without
                                                      strict dress codes, such
                                                      as designers,
                                                ...
                                                >
                                                  ...
                                                  <ul className="flex flex-col gap-3">
                                                    ...
                                                    <li>
                                                      ...
                                                      <br />
                                                      Shared apartments, dorms,
                                                      or small studio spaces
                                                    </li>
                                                  </ul>
                                                </motion.div>
                                                ...
                                                >
                                                  ...
                                                  <div className="flex flex-col gap-3">
                                                    <p>
                                                      Target customers are less
                                                      concerned with maintaining
                                                      a perfect or polished
                                                      appearance and more
                                                      interested in garments
                                                      that feel natural and
                                                      personal.
                                                    </p>
                                                    <p>
                                                      They tend to appreciate
                                                      clothing that ages with
                                                      them over time. Slight
                                                      wear, fading, or marks are
                                                      not seen as flaws but as
                                                      traces of experience and
                                                      daily life. These subtle
                                                      changes make the garment
                                                      feel more personal and
                                                      lived-in.
                                                    </p>
                                                  </div>
                                                </motion.div>
                                                ...
                                                >
                                                  ...
                                                  <div className="flex flex-col gap-3">
                                                    <p>
                                                      ...
                                                      and repeatedly wear the
                                                      same garments in different
                                                      contexts. Their clothing
                                                      must move easily between
                                                      multiple situations
                                                      throughout the day.
                                                    </p>
                                                    <div>
                                                      <span className="block mb-2 font-medium text-black/80">
                                                        Typical activities
                                                        include:
                                                      </span>
                                                      <ul className="list-disc pl-4 flex flex-col gap-2">
                                                        <li>
                                                          working in studios or
                                                          creative spaces
                                                        </li>
                                                        <li>
                                                          socializing in bars or
                                                          casual nightlife
                                                          settings
                                                        </li>
                                                        <li>
                                            ...
                                            <div className="absolute inset-0 z-[0] md:z-[2] pointer-events-none">
                                                ...
                                                <div className="opacity-0 group-hover:opacity-100 transition-all duration-[1s] ease-[cubic-bezier(0.16,1,0.3,1)] delay-75 scale-75 group-hover:scale-100 -translate-y-4 group-hover:-translate-y-[320px] md:group-hover:-translate-y-[280px] group-hover:-translate-x-[50px] md:group-hover:-translate-x-[550px]">
                                                  <div className="flex gap-3 md:gap-4 items-start">
                                                    ...
                                                    <div className="flex flex-col gap-1 md:gap-2">
                                                      <h5 className="text-[0.6rem] md:text-[0.65rem] uppercase tracking-[0.2em] font-bold text-black pb-2">
                                                        Blood Line Red
                                                      </h5>
                                                      <p className="text-[0.65rem] md:text-[0.75rem] text-black/60 leading-relaxed font-light mt-1">
                                                        A deep red inspired by
                                                ...
                                                <div className="opacity-0 group-hover:opacity-100 transition-all duration-[1.2s] ease-[cubic-bezier(0.16,1,0.3,1)] delay-100 scale-75 group-hover:scale-100 -translate-y-4 group-hover:-translate-y-[150px] md:group-hover:translate-y-[-20px] group-hover:translate-x-[50px] md:group-hover:-translate-x-[600px]">
                                                  <div className="flex gap-3 md:gap-4 items-start">
                                                    ...
                                                    <div className="flex flex-col gap-1 md:gap-2">
                                                      ...
                                                      <p className="text-[0.65rem] md:text-[0.75rem] text-black/60 leading-relaxed font-light mt-1">
                                                        A muted grey that
                                                        recalls dust, ash, and
                                                        worn surfaces. It
                                                        introduces a quiet and
                                                        aged atmosphere,
                                                        suggesting erosion and
                                                        the passage of time.
                                                      </p>
                                                    </div>
                                                  </div>
                                                ...
                                                <div className="opacity-0 group-hover:opacity-100 transition-all duration-[1.1s] ease-[cubic-bezier(0.16,1,0.3,1)] delay-150 scale-75 group-hover:scale-100 -translate-y-4 group-hover:translate-y-[170px] md:group-hover:translate-y-[240px] group-hover:-translate-x-[50px] md:group-hover:-translate-x-[500px]">
                                                  <div className="flex gap-3 md:gap-4 items-start">
                                                    ...
                                                    <div className="flex flex-col gap-1 md:gap-2">
                                                      ...
                                                      <p className="text-[0.65rem] md:text-[0.75rem] text-black/60 leading-relaxed font-light mt-1">
                                                        A warm, dusty yellow
                                                        inspired by scorched
                                                        soil and sun-dried
                                                        materials. This color
                                                        reflects heat, dryness,
                                                ...
                                                <div className="opacity-0 group-hover:opacity-100 transition-all duration-[1.3s] ease-[cubic-bezier(0.16,1,0.3,1)] delay-200 scale-75 group-hover:scale-100 -translate-y-4 group-hover:translate-y-[340px] md:group-hover:translate-y-[220px] group-hover:translate-x-[50px] md:group-hover:translate-x-[420px]">
                                                  <div className="flex gap-3 md:gap-4 items-start">
                                                    ...
                                                    <div className="flex flex-col gap-1 md:gap-2">
                                                      ...
                                                      <p className="text-[0.65rem] md:text-[0.75rem] text-black/60 leading-relaxed font-light mt-1">
                                                        A deep black that
                                                        anchors the palette. It
                                                        adds strength and
                                                        contrast, creating a
                                                        dark foundation for the
                                                        other colors.
                                                      </p>
                                                    </div>
                                                  </div>
                                              ...
                                              <div className="absolute top-1/2 left-1/2 w-[260px] md:w-[380px] -translate-x-1/2 -translate-y-1/2 pointer-events-none group-hover:pointer-events-auto">
                                                <div className="opacity-0 group-hover:opacity-100 transition-all duration-[1.4s] ease-[cubic-bezier(0.16,1,0.3,1)] delay-300 scale-75 group-hover:scale-100 translate-y-8 group-hover:-translate-y-[480px] md:group-hover:-translate-y-[200px] group-hover:translate-x-0 md:group-hover:translate-x-[450px] bg-white/95 backdrop-blur-md p-5 md:p-8 shadow-2xl">
                                                  ...
                                                  <h4 className="text-[0.55rem] md:text-[0.65rem] tracking-[0.4em] font-bold text-[#ff1e00] uppercase mb-3 pb-2">
                                                    ADDITIONAL INSPIRATION
                                                  </h4>
                                                  <p className="text-[0.65rem] md:text-[0.8rem] text-black/70 leading-relaxed font-light">
                                                    The costume design in this
                                                    stop-motion animation
                                                    inspired the idea of visible
                                                    threads and stitching. Red
                                                    yarn lines appearing on the
                                                    garments create a strong
                                                    visual detail that feels
                                                    both fragile and tense. This
                                                    element connects to the
                                                    concept of a{" "}
                                                    <strong className="font-medium text-black">
                                                      “blood line”
                                                    </strong>{" "}
                                                    and influenced my interest
                                                    in raw edges, loose threads,
                                                    and exposed seams.
                                                  </p>
                                                </div>
                                              </div>
                                        ...
                                        {activeConceptTab === 3 && (
                                          <div className="flex flex-col py-12 md:py-24">
                                            <div className="mb-16 md:mb-24 lg:w-[60%]">
                                              <p className="text-[0.8rem] tracking-[0.3em] uppercase text-black/30 font-bold mb-6">
                                                Fabric & Manipulation
                                              </p>
                                              <h3 className="text-3xl md:text-5xl font-['Playfair_Display'] italic mb-8">
                                                Materiality & Structural Forms
                                              </h3>
                                            </div>
                                    ...
                                    <div className="pl-8 pb-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                                      <div className="flex flex-col gap-4">
                                        <div
                                          className={`aspect-[4/5] bg-gray-${100 + pIdx * 100} grayscale contrast-125`}
                                        />
                                        <p className="text-[0.6rem] tracking-[0.2em] opacity-40 uppercase">
                                          Archival Entry_0{pIdx + 1}A
                                        </p>
                                      </div>
                                      <div className="flex flex-col gap-4 pt-12">
                                        <div
                                          className={`aspect-[3/4] bg-gray-${200 + pIdx * 100} grayscale brightness-75`}
                                        />
                                        <p className="text-[0.6rem] tracking-[0.2em] opacity-40 uppercase">
                                          Archival Entry_0{pIdx + 1}B
                                        </p>
                                      </div>
                                    </div>
                                  )}
                          ...
                          <div className="flex flex-col gap-6">
                            {[
                              {
                                id: "INSPIRATION",
                                imgA: "https://raw.githubusercontent.com/jmeng260-hash/000/95651cd9e263cd17ab9933ba9b46a9c6c4ac79d2/%E6%9C%AA%E5%91%BD%E5%90%8D%E4%BD%9C%E5%93%81%2044.png",
                                imgB: "https://raw.githubusercontent.com/jmeng260-hash/000/95651cd9e263cd17ab9933ba9b46a9c6c4ac79d2/IMG_7780.JPG",
                              },
                              {
                                id: "TARGET CUSTOMER",
                                imgA: "https://raw.githubusercontent.com/jmeng260-hash/target-customer02/683d522e1758ad5a70d484aa8a6306ed22e8a679/%E6%9C%AA%E5%91%BD%E5%90%8D%E4%BD%9C%E5%93%81%20101.jpg",
                              },
                              {
                                id: "FABRIC",
                                imgA: "https://raw.githubusercontent.com/jmeng260-hash/color-story-fabric/e85c10c239a7669c862a68c6de1a8414e1f23529/%E6%88%AA%E5%B1%8F2026-05-01%2019.08.30.png",
                                imgB: "https://raw.githubusercontent.com/jmeng260-hash/color-story-fabric/e85c10c239a7669c862a68c6de1a8414e1f23529/%E6%88%AA%E5%B1%8F2026-05-01%2019.08.47.png",
                              },
                              {
                                id: "PROCESS",
                                images: [
                              ...
                              {
                                id: "LOOKS",
                                imgA: "https://raw.githubusercontent.com/jmeng260-hash/look/fd32aa6cc20997b8edb7184a4b03bd5598814cf1/%E6%9C%AA%E5%91%BD%E5%90%8D%E4%BD%9C%E5%93%81%2046.png",
                              },
                            ].map((phase, pIdx) => (
                              <div key={pIdx} className="flex flex-col gap-4">
                                <button
                                  ...
                                  {phase.id === "TARGET CUSTOMER" ? (
                                    <div className="pl-4 md:pl-8 pb-12 flex flex-col gap-10 md:gap-14">
                                      <div className="flex flex-col gap-4">
                                        <div className="w-full relative group/img z-0 hover:z-[60] transition-all duration-500 cursor-zoom-in mix-blend-multiply">
                                          <img
                                            src={phase.imgA}
                                            alt={`Fluid detail 0${pIdx + 1}A`}
                                            className="w-[100%] md:w-[80%] lg:w-[70%] max-w-5xl h-auto object-contain transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] origin-top-left group-hover/img:scale-[1.3] md:group-hover/img:scale-[1.5] lg:group-hover/img:scale-[1.7] relative z-10 mix-blend-multiply drop-shadow-none brightness-[1.1] contrast-[1.1]"
                                          />
                                        </div>
                                        <p className="text-[0.6rem] tracking-[0.2em] opacity-40 uppercase pt-2">
                                          {phase.id}_{pIdx + 1}A
                                        </p>
                                      </div>

                                      <div className="flex flex-col gap-6 max-w-3xl">
                                        <h4 className="text-[0.8rem] md:text-[1rem] tracking-[0.3em] font-bold text-black uppercase border-b border-black/10 pb-4">
                                          Target Customer
                                        </h4>
                                        <div className="flex flex-col gap-5 text-[0.75rem] md:text-[0.85rem] text-black/70 leading-relaxed font-light">
                                          <p>
                                            My target customer is an urban
                                            creative person between 18 and 30
                                            years old. They may be fashion
                                            students, art students, stylists,
                                            musicians, freelancers, or people
                                            working in creative spaces without a
                                            strict dress code. Their lifestyle
                                            moves between school, studio, city
                                            streets, cafés, bars, galleries, and
                                            nightlife spaces.
                                          </p>
                                          <p>
                                            They are not looking for clothing
                                            that feels too polished or perfect.
                                            They are attracted to layering,
                                            texture, structure, and personal
                                            character. Their wardrobe often
                                            includes dark neutral colors,
                                            vintage pieces, oversized shapes,
                                            fitted details, and garments that
                                            feel slightly worn or lived-in.
                                          </p>
                                          <p>
                                            This customer dresses with attitude,
                                            but not in a loud way. Their style
                                            feels independent, emotional, and
                                            personal. They are drawn to clothing
                                            that can move with their daily life
                                            and express both softness and
                                            strength.
                                          </p>
                                        </div>
                                      </div>
                                    ...
                                    <div className="w-full py-20 md:py-32 flex justify-center items-center scatter-scene relative h-[600px] md:h-[800px] cursor-crosshair">
                                      ...
                                      {phase.images.map((imgSrc, imgIdx) => {
                                        ...
                                        const pos =
                                          positions[imgIdx % positions.length];
                                      ...
                                      <div className="flex flex-col gap-4 pt-12 md:pt-[35%] lg:pt-[40%] w-full md:w-[50%] lg:w-[45%] relative z-0 md:-ml-12 lg:-ml-20">
                                        {phase.imgB ? (
                                          <div className="w-full relative group/img hover:z-[60] transition-all duration-700 cursor-zoom-in mix-blend-multiply">
                                            <img
                                              src={phase.imgB}
                                              alt={`Fluid detail 0${pIdx + 1}B`}
                                              className="w-[115%] md:w-[130%] lg:w-[140%] h-auto object-contain transition-all duration-[1.5s] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover/img:scale-[1.4] md:group-hover/img:scale-[1.6] lg:group-hover/img:scale-[1.8] mix-blend-multiply drop-shadow-none brightness-[1.05] contrast-[1.05] origin-top-left md:translate-x-10 lg:translate-x-12 relative z-50"
                                            />
                                          </div>
                                        ) : (
                                        ...
                                        <p className="text-[0.6rem] tracking-[0.2em] opacity-40 uppercase pt-4 z-50 md:pl-10 lg:pl-12">
                                          {phase.id}_{pIdx + 1}B
                                        </p>
                                      </div>
                                    </div>
      ...
      <footer className="w-full px-8 pb-12 flex flex-col md:flex-row justify-between items-end gap-12 text-[0.72rem] leading-[1.5] text-black/55 z-50 mix-blend-difference text-white">
        <div className="max-w-[400px]">
          ...
          <p>
            The form is not broken. It is intentionally shifted, stretched, and
            reassembled into a new body. We seek truth in the deviation.
          </p>
        </div>
          ...
          >
            ...
            >
              <animate
                ...
                dur="14s"
                values="0.018 0.042; 0.045 0.018; 0.018 0.042"
          ...
          >
            ...
            >
              <animate
                attributeName="baseFrequency"
                dur="20s"
                values="0.012 0.024; 0.024 0.012; 0.012 0.024"
                repeatCount="indefinite"
              />
            </feTurbulence>
            <feDisplacementMap
          ...
          >
            ...
            >
              <animate
                attributeName="baseFrequency"
                dur="18s"
                values="0.012 0.03; 0.032 0.016; 0.012 0.03"
                repeatCount="indefinite"
              />
            </feTurbulence>
            <feDisplacementMap
